...
var coder{{.Name}} = pointerCoderFuncs{size{{.Name}}, append{{.Name}}}
...
var coder{{.Name}}NoZero = pointerCoderFuncs{size{{.Name}}NoZero, append{{.Name}}NoZero}
...
var coder{{.Name}}Ptr = pointerCoderFuncs{size{{.Name}}Ptr, append{{.Name}}Ptr}
{{end}}
...
var coder{{.Name}}Slice = pointerCoderFuncs{size{{.Name}}Slice, append{{.Name}}Slice}
...
var coder{{.Name}}PackedSlice = pointerCoderFuncs{size{{.Name}}PackedSlice, append{{.Name}}PackedSlice}
...
var coder{{.Name}}Iface = ifaceCoderFuncs{size{{.Name}}Iface, append{{.Name}}Iface}
...
var coder{{.Name}}SliceIface = ifaceCoderFuncs{size{{.Name}}SliceIface, append{{.Name}}SliceIface}
